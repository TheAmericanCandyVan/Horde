...
include("arccw/attachments/horde_ubgl_incendiary.lua")
include("arccw/attachments/horde_ubgl_shock.lua")
include("arccw/attachments/horde_ubgl_cryo.lua")
...
include("arccw/attachments/eap_usas_barrel_short.lua")
include("arccw/attachments/eap_usas_mag_6.lua")
...
include("arccw/attachments/horde_go_perk_bandito.lua")
include("arccw/attachments/horde_negev_hemo_belt.lua")
include("arccw/attachments/horde_m249_12g_belt.lua")
...
killicon.Add("npc_vj_horde_smg_turret", "vgui/hud/npc_turret_floor", Color(0, 0, 0, 255))
