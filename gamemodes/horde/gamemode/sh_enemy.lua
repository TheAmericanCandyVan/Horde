...
function HORDE:GetDefaultEnemiesData ()
    ...
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 1.0, music = "#horde/music/mutated_hulk.mp3", music_duration = 168}, nil, nil, nil, nil, {gadget = "gadget_unstable_injection", drop_rate = 0.75})
    HORDE:CreateEnemy("Plague Berserker", "npc_vj_horde_platoon_berserker", 0.35, 5, true, 1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 1.0, music = "#horde/music/plague_berserker.mp3", music_duration = 152})
    HORDE:CreateEnemy("Plague Heavy", "npc_vj_horde_platoon_heavy", 0.35, 5, true, 1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 1.0, music = "#horde/music/plague_heavy.mp3", music_duration = 152})
    HORDE:CreateEnemy("Plague Demolition","npc_vj_horde_platoon_demolitionist", 0.35, 5, true, 1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 1.0, music = "#horde/music/plague_demolitionist.mp3", music_duration = 152})
    HORDE:CreateEnemy("Hell Knight", "npc_vj_horde_hellknight", 1, 5, true, 1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave=true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 0.5, music = "#horde/music/hell_knight.mp3", music_duration = 129}, "none", nil, nil, nil, {gadget = "gadget_hellfire_tincture", drop_rate = 0.75})
    HORDE:CreateEnemy("Xen Host Unit", "npc_vj_horde_xen_host_unit", 1, 5, true, 1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 0.5, music = "#horde/music/xen_host_unit.mp3", music_duration = 106}, "none", nil, nil, nil, {gadget = "gadget_matriarch_womb", drop_rate = 0.75})
    HORDE:CreateEnemy("Xen Necromancer Unit", "npc_vj_horde_xen_necromancer_unit", 1, 5, true, 1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 0.5, music = "#horde/music/xen_reanimator_unit.mp3", music_duration = 64})

    -- Final Bosses
    HORDE:CreateEnemy("Alpha Gonome", "npc_vj_alpha_gonome", 1, 10, true, 1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 0.5, music = "#horde/music/alpha_gonome.mp3", music_duration = 150}, "fume")
    HORDE:CreateEnemy("Gamma Gonome", "npc_vj_horde_gamma_gonome", 1, 10, true, 1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 0.5, music = "#horde/music/gamma_gonome.mp3", music_duration = 76}, "none")
    HORDE:CreateEnemy("Subject: Wallace Breen", "npc_vj_horde_breen", 1, 10, true,  1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 0.5, music = "#horde/music/wallace_breen.mp3", music_duration = 69}, "decay")
    HORDE:CreateEnemy("Xen Destroyer Unit","npc_vj_horde_xen_destroyer_unit", 1,    10, true,  1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 0.5, music = "#horde/music/xen_destroyer_unit.mp3", music_duration = 196}, "none")
    HORDE:CreateEnemy("Xen Psychic Unit","npc_vj_horde_xen_psychic_unit", 1, 10, true, 1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 0.5, music = "#horde/music/xen_psychic_unit.mp3", music_duration = 80}, "regenerator")
    HORDE:CreateEnemy("Plague Platoon","npc_vj_horde_plague_platoon", 1, 10, true, 1, 1, 10, 1, nil, nil, nil,
    {is_boss = true, end_wave = true, unlimited_enemies_spawn = true, enemies_spawn_threshold = 1.0, music = "#horde/music/plague_platoon.mp3", music_duration = 152}, "none")
    ...
    if GetConVar( "horde_difficulty" ):GetInt() == 1 then -- CASUAL
        ...
        HORDE:CreateEnemy("Armed H.E.V. Zombie",        "npc_vj_ezt_weapbie",           0.08, 4, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("H.E.V. Zombie Shotgunner",   "npc_vj_ezt_shotbie",           0.08, 4, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Manhackbie",                 "npc_vj_ezt_manhackbie",        0.10, 4, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 4, false, 1, 1, 1, 1)
        -- First Boss Wave
        ...
        HORDE:CreateEnemy("Armed H.E.V. Zombie",        "npc_vj_ezt_weapbie",           0.08, 5, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("H.E.V. Zombie Shotgunner",   "npc_vj_ezt_shotbie",           0.08, 5, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Manhackbie",                 "npc_vj_ezt_manhackbie",        0.10, 5, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 5, false, 1, 1, 1, 1)
        -- Wave 6
        ...
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 6, false, 1, 1, 1, 1)
        -- Wave 7
        ...
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 7, false, 1, 1, 1, 1)
        -- Wave 8
        ...
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 8, false, 1, 1, 1, 1)
        -- Wave 9
        ...
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 9, false, 1, 1, 1, 1)
        -- Final Boss Wave
        ...
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 10, false, 1, 1, 1, 1)
    elseif GetConVar( "horde_difficulty" ):GetInt() == 6 then -- ELITE-RUSH
        ...
        HORDE:CreateEnemy("Vomitter",   "npc_vj_horde_vomitter",    0.15, 1, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Burnzie",    "npc_vj_horde_burnzie",     0.20, 1, true, 1, 1, 1.5, 1)
        -- Wave 2
        HORDE:CreateEnemy("Exploder",   "npc_vj_horde_exploder",    1.00, 2, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Vomitter",   "npc_vj_horde_vomitter",    0.15, 2, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",  "npc_vj_horde_screecher",   0.30, 2, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Burnzie",    "npc_vj_horde_burnzie",     0.20, 2, true, 1, 1, 1.5, 1)
        ...
        HORDE:CreateEnemy("Vomitter",   "npc_vj_horde_vomitter",    0.15, 3, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",  "npc_vj_horde_screecher",   0.30, 3, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Burnzie",    "npc_vj_horde_burnzie",     0.20, 3, true, 1, 1, 1.5, 1)
        ...
        HORDE:CreateEnemy("Vomitter",           "npc_vj_horde_vomitter",            0.15, 4, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",          "npc_vj_horde_screecher",           0.30, 4, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Hulk",               "npc_vj_horde_hulk",                0.20, 4, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Burnzie",            "npc_vj_horde_burnzie",             0.20, 4, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",             "npc_vj_horde_eschar",              0.10, 4, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",           "npc_vj_horde_sorcerer",            0.03, 4, true, 1, 1, 1.5, 1)
        -- First Boss Wave
        HORDE:CreateEnemy("Exploder",           "npc_vj_horde_exploder",            1.00, 5, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Vomitter",           "npc_vj_horde_vomitter",            0.15, 5, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Scorcher",           "npc_vj_horde_scorcher",            0.10, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",          "npc_vj_horde_screecher",           0.30, 5, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Hulk",               "npc_vj_horde_hulk",                0.20, 5, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Burnzie",            "npc_vj_horde_burnzie",             0.20, 5, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",             "npc_vj_horde_eschar",              0.10, 5, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",           "npc_vj_horde_sorcerer",            0.03, 5, true, 1, 1, 1.5, 1)
        -- Wave 6
        HORDE:CreateEnemy("Exploder",           "npc_vj_horde_exploder",        1.00, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Blight",             "npc_vj_horde_blight",          0.40, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Vomitter",           "npc_vj_horde_vomitter",        0.15, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Scorcher",           "npc_vj_horde_scorcher",        0.10, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",          "npc_vj_horde_screecher",       0.30, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Weeper",             "npc_vj_horde_weeper",          0.15, 6, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Hulk",               "npc_vj_horde_hulk",            0.20, 6, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Yeti",               "npc_vj_horde_yeti",            0.10, 6, true, 1, 1, 2.5, 1)
        HORDE:CreateEnemy("Lesion",             "npc_vj_horde_lesion",          0.05, 6, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Burnzie",            "npc_vj_horde_burnzie",         0.20, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",             "npc_vj_horde_eschar",          0.10, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",           "npc_vj_horde_sorcerer",        0.03, 6, true, 1, 1, 1.5, 1)
        -- Wave 7
        HORDE:CreateEnemy("Exploder",           "npc_vj_horde_exploder",        1.00, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Blight",             "npc_vj_horde_blight",          0.40, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Vomitter",           "npc_vj_horde_vomitter",        0.15, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Scorcher",           "npc_vj_horde_scorcher",        0.10, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",          "npc_vj_horde_screecher",       0.30, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Weeper",             "npc_vj_horde_weeper",          0.15, 7, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Hulk",               "npc_vj_horde_hulk",            0.20, 7, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Yeti",               "npc_vj_horde_yeti",            0.10, 7, true, 1, 1, 2.5, 1)
        HORDE:CreateEnemy("Lesion",             "npc_vj_horde_lesion",          0.05, 7, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Burnzie",            "npc_vj_horde_burnzie",         0.20, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",             "npc_vj_horde_eschar",          0.10, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",           "npc_vj_horde_sorcerer",        0.03, 7, true, 1, 1, 1.5, 1)
        -- Wave 8
        HORDE:CreateEnemy("Exploder",           "npc_vj_horde_exploder",        1.00, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Blight",             "npc_vj_horde_blight",          0.40, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Vomitter",           "npc_vj_horde_vomitter",        0.15, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Scorcher",           "npc_vj_horde_scorcher",        0.10, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",          "npc_vj_horde_screecher",       0.30, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Weeper",             "npc_vj_horde_weeper",          0.15, 8, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Hulk",               "npc_vj_horde_hulk",            0.20, 8, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Yeti",               "npc_vj_horde_yeti",            0.10, 8, true, 1, 1, 2.5, 1)
        HORDE:CreateEnemy("Lesion",             "npc_vj_horde_lesion",          0.05, 8, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Plague Elite",       "npc_vj_horde_plague_elite",    0.03, 8, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Burnzie",            "npc_vj_horde_burnzie",         0.20, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",             "npc_vj_horde_eschar",          0.10, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",           "npc_vj_horde_sorcerer",        0.03, 8, true, 1, 1, 1.5, 1)
        -- Wave 9
        HORDE:CreateEnemy("Exploder",           "npc_vj_horde_exploder",        1.00, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Blight",             "npc_vj_horde_blight",          0.40, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Vomitter",           "npc_vj_horde_vomitter",        0.15, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Scorcher",           "npc_vj_horde_scorcher",        0.10, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",          "npc_vj_horde_screecher",       0.30, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Weeper",             "npc_vj_horde_weeper",          0.15, 9, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Hulk",               "npc_vj_horde_hulk",            0.20, 9, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Yeti",               "npc_vj_horde_yeti",            0.10, 9, true, 1, 1, 2.5, 1)
        HORDE:CreateEnemy("Lesion",             "npc_vj_horde_lesion",          0.05, 9, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Plague Elite",       "npc_vj_horde_plague_elite",    0.03, 9, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Burnzie",            "npc_vj_horde_burnzie",         0.20, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",             "npc_vj_horde_eschar",          0.10, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",           "npc_vj_horde_sorcerer",        0.03, 9, true, 1, 1, 1.5, 1)
        -- Final Boss Wave
        HORDE:CreateEnemy("Exploder",           "npc_vj_horde_exploder",        1.00, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Blight",             "npc_vj_horde_blight",          0.40, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Vomitter",           "npc_vj_horde_vomitter",        0.15, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Scorcher",           "npc_vj_horde_scorcher",        0.10, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",          "npc_vj_horde_screecher",       0.30, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Weeper",             "npc_vj_horde_weeper",          0.15, 10, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Hulk",               "npc_vj_horde_hulk",            0.20, 10, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Yeti",               "npc_vj_horde_yeti",            0.10, 10, true, 1, 1, 2.5, 1)
        HORDE:CreateEnemy("Lesion",             "npc_vj_horde_lesion",          0.05, 10, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Plague Elite",       "npc_vj_horde_plague_elite",    0.03, 10, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Burnzie",            "npc_vj_horde_burnzie",         0.20, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",             "npc_vj_horde_eschar",          0.10, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",           "npc_vj_horde_sorcerer",        0.03, 10, true, 1, 1, 1.5, 1)
    else
        -- Wave 1
        HORDE:CreateEnemy("Walker",         "npc_vj_horde_walker",          1.00, 1, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Sprinter",       "npc_vj_horde_sprinter",        0.80, 1, false, 1, 1, 1, 1)
        ...
        HORDE:CreateEnemy("Vomitter",       "npc_vj_horde_vomitter",        0.10, 3, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Burnzie",        "npc_vj_horde_burnzie",         0.10, 3, true, 1, 1, 1.5, 1)
        -- Wave 4
        HORDE:CreateEnemy("Walker",                     "npc_vj_horde_walker",          1.00, 4, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Sprinter",                   "npc_vj_horde_sprinter",        0.80, 4, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Crawler",                    "npc_vj_horde_crawler",         0.50, 4, false, 1, 1, 1, 1)
        ...
        HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",        0.10, 4, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",       0.10, 4, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Armed H.E.V. Zombie",        "npc_vj_ezt_weapbie",           0.08, 4, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("H.E.V. Zombie Shotgunner",   "npc_vj_ezt_shotbie",           0.08, 4, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Manhackbie",                 "npc_vj_ezt_manhackbie",        0.10, 4, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 4, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Burnzie",                    "npc_vj_horde_burnzie",         0.10, 4, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",                     "npc_vj_horde_eschar",          0.10, 4, true, 1, 1, 1.5, 1)
        -- First Boss Wave
        HORDE:CreateEnemy("Walker",                     "npc_vj_horde_walker",          1.00, 5, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Sprinter",                   "npc_vj_horde_sprinter",        0.80, 5, false, 1, 1, 1, 1)
        ...
        HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",        0.10, 5, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",       0.10, 5, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Armed H.E.V. Zombie",        "npc_vj_ezt_weapbie",           0.08, 5, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("H.E.V. Zombie Shotgunner",   "npc_vj_ezt_shotbie",           0.08, 5, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Manhackbie",                 "npc_vj_ezt_manhackbie",        0.10, 5, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 5, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Burnzie",                    "npc_vj_horde_burnzie",         0.10, 5, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",                     "npc_vj_horde_eschar",          0.10, 5, true, 1, 1, 1.5, 1)
        -- Wave 6
        HORDE:CreateEnemy("Walker",                     "npc_vj_horde_walker",          1.00, 6, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Sprinter",                   "npc_vj_horde_sprinter",        1.00, 6, false, 1, 1, 1, 1)
        ...
        HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",        0.10, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Scorcher",                   "npc_vj_horde_scorcher",        0.08, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",       0.10, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Hulk",                       "npc_vj_horde_hulk",            0.05, 6, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Armed H.E.V. Zombie",        "npc_vj_ezt_weapbie",           0.08, 6, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("H.E.V. Zombie Shotgunner",   "npc_vj_ezt_shotbie",           0.08, 6, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Manhackbie",                 "npc_vj_ezt_manhackbie",        0.10, 6, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 6, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Burnzie",                    "npc_vj_horde_burnzie",         0.10, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",                     "npc_vj_horde_eschar",          0.10, 6, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",                   "npc_vj_horde_sorcerer",        0.02, 6, true, 1, 1, 4, 1)
        -- Wave 7
        HORDE:CreateEnemy("Walker",                     "npc_vj_horde_walker",          1.00, 7, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Sprinter",                   "npc_vj_horde_sprinter",        1.00, 7, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Crawler",                    "npc_vj_horde_crawler",         0.50, 7, false, 1, 1, 1, 1)
        ...
        HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",        0.10, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Scorcher",                   "npc_vj_horde_scorcher",        0.08, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",       0.10, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Hulk",                       "npc_vj_horde_hulk",            0.05, 7, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Lesion",                     "npc_vj_horde_lesion",          0.01, 7, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Armed H.E.V. Zombie",        "npc_vj_ezt_weapbie",           0.08, 7, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("H.E.V. Zombie Shotgunner",   "npc_vj_ezt_shotbie",           0.08, 7, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Manhackbie",                 "npc_vj_ezt_manhackbie",        0.10, 7, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 7, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Burnzie",                    "npc_vj_horde_burnzie",         0.10, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",                     "npc_vj_horde_eschar",          0.10, 7, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",                   "npc_vj_horde_sorcerer",        0.02, 7, true, 1, 1, 4, 1)
        -- Wave 8
        HORDE:CreateEnemy("Sprinter",                   "npc_vj_horde_sprinter",        1.00, 8, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Crawler",                    "npc_vj_horde_crawler",         0.50, 8, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Fast Zombie",                "npc_vj_horde_fast_zombie",     0.25, 8, false, 1, 1, 1, 1)
        ...
        HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",        0.10, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Scorcher",                   "npc_vj_horde_scorcher",        0.10, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",       0.10, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Weeper",                     "npc_vj_horde_weeper",          0.03, 8, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Hulk",                       "npc_vj_horde_hulk",            0.05, 8, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Yeti",                       "npc_vj_horde_yeti",            0.02, 8, true, 1, 1, 2.5, 1)
        HORDE:CreateEnemy("Lesion",                     "npc_vj_horde_lesion",          0.01, 8, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Armed H.E.V. Zombie",        "npc_vj_ezt_weapbie",           0.08, 8, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("H.E.V. Zombie Shotgunner",   "npc_vj_ezt_shotbie",           0.08, 8, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Manhackbie",                 "npc_vj_ezt_manhackbie",        0.10, 8, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 8, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Burnzie",                    "npc_vj_horde_burnzie",         0.10, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",                     "npc_vj_horde_eschar",          0.10, 8, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",                   "npc_vj_horde_sorcerer",        0.02, 8, true, 1, 1, 4, 1)
        -- Wave 9
        HORDE:CreateEnemy("Sprinter",                   "npc_vj_horde_sprinter",        1.00, 9, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Crawler",                    "npc_vj_horde_crawler",         0.50, 9, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Fast Zombie",                "npc_vj_horde_fast_zombie",     0.25, 9, false, 1, 1, 1, 1)
        ...
        HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",        0.10, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Scorcher",                   "npc_vj_horde_scorcher",        0.08, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",       0.10, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Weeper",                     "npc_vj_horde_weeper",          0.03, 9, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Hulk",                       "npc_vj_horde_hulk",            0.05, 9, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Yeti",                       "npc_vj_horde_yeti",            0.02, 9, true, 1, 1, 2.5, 1)
        HORDE:CreateEnemy("Lesion",                     "npc_vj_horde_lesion",          0.01, 9, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Plague Elite",               "npc_vj_horde_plague_elite",    0.01, 9, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Armed H.E.V. Zombie",        "npc_vj_ezt_weapbie",           0.08, 9, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("H.E.V. Zombie Shotgunner",   "npc_vj_ezt_shotbie",           0.08, 9, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Manhackbie",                 "npc_vj_ezt_manhackbie",        0.10, 9, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 9, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Burnzie",                    "npc_vj_horde_burnzie",         0.10, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",                     "npc_vj_horde_eschar",          0.10, 9, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",                   "npc_vj_horde_sorcerer",        0.02, 9, true, 1, 1, 1.5, 1)
        -- Final Boss Wave
        HORDE:CreateEnemy("Sprinter",                   "npc_vj_horde_sprinter",        1.00, 10, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Crawler",                    "npc_vj_horde_crawler",         0.50, 10, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Fast Zombie",                "npc_vj_horde_fast_zombie",     0.25, 10, false, 1, 1, 1, 1)
        ...
        HORDE:CreateEnemy("Blight",                     "npc_vj_horde_blight",          0.05, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",        0.10, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Scorcher",                   "npc_vj_horde_scorcher",        0.08, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",       0.10, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Weeper",                     "npc_vj_horde_weeper",          0.03, 10, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Hulk",                       "npc_vj_horde_hulk",            0.05, 10, true, 1, 1, 2, 1)
        HORDE:CreateEnemy("Yeti",                       "npc_vj_horde_yeti",            0.02, 10, true, 1, 1, 2.5, 1)
        HORDE:CreateEnemy("Lesion",                     "npc_vj_horde_lesion",          0.01, 10, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Plague Elite",               "npc_vj_horde_plague_elite",    0.01, 10, true, 1, 1, 4, 1)
        HORDE:CreateEnemy("Armed H.E.V. Zombie",        "npc_vj_ezt_weapbie",           0.08, 10, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("H.E.V. Zombie Shotgunner",   "npc_vj_ezt_shotbie",           0.08, 10, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Manhackbie",                 "npc_vj_ezt_manhackbie",        0.10, 10, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Subordinate",                "npc_vj_horde_subordinate",     0.10, 10, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Burnzie",                    "npc_vj_horde_burnzie",         0.10, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Eschar",                     "npc_vj_horde_eschar",          0.10, 10, true, 1, 1, 1.5, 1)
        HORDE:CreateEnemy("Sorcerer",                   "npc_vj_horde_sorcerer",        0.02, 10, true, 1, 1, 4, 1)
