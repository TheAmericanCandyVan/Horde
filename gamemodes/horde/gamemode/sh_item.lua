...
function HORDE:GetDefaultGadgets()
    ...
    -- Survivor --
    HORDE:CreateGadgetItem( "gadget_vitality_booster", 2500, 1, { Survivor = true, Psycho = true, Prototype = true }, { Survivor = 5 } )
    HORDE:CreateGadgetItem( "gadget_damage_booster", 2500, 1, { Survivor = true, Psycho = true, Prototype = true }, { Survivor = 10 } )
    HORDE:CreateGadgetItem( "gadget_agility_booster", 2500, 1, { Survivor = true, Psycho = true, Prototype = true }, { Survivor = 15 } )
    HORDE:CreateGadgetItem( "gadget_resistance_booster", 2500, 1, { Survivor = true, Psycho = true, Prototype = true }, { Survivor = 20 } )
    HORDE:CreateGadgetItem( "gadget_ultimate_booster", 4000, 3, { Survivor = true, Psycho = true, Prototype = true }, { Survivor = 25 } )
...
function HORDE:GetDefaultItemInfusions()
    ...
    HORDE.items["arccw_horde_jotuun"].infusions = melee_blunt_infusions
    HORDE.items["arccw_horde_inferno_blade"].infusions = melee_slash_infusions
    ...
    HORDE.items["arccw_horde_bo_asp"].infusions = ballistic_infusions_light
    HORDE.items["arccw_horde_bo_cz75"].infusions = ballistic_infusions_light
...
function HORDE:GetDefaultItemsData()
    HORDE:CreateItem( "Melee", "Combat Knife", "arccw_horde_knife", 100, 0,
        ...
        { Survivor = true, Psycho = true, Prototype = true, Assault = true, SpecOps = true, Reverend = true, Heavy = true, Juggernaut = true, Medic = true, Hatcher = true, Demolition = true, Ghost = true, Gunslinger = true, Engineer = true, Berserker = true, Samurai = true, ["Cyborg Ninja"] = true, Warden = true, Overlord = true, Paladin = true, Cremator = true },
        10, -1, nil, nil, nil, nil, { HORDE.DMG_SLASH }, nil, { "Berserker", "Samurai", "Cyborg Ninja", "Paladin" } )
    ...
    HORDE:CreateItem( "Melee", "Kunai", "arccw_horde_kunai", 1750, 2,
        ...
        { Survivor = true, Psycho = true, Prototype = true, Berserker = true, Samurai = true, ["Cyborg Ninja"] = true, Paladin = true },
    ...
    HORDE:CreateItem( "Melee", "Inferno", "arccw_horde_inferno_blade", 2500, 6,
        ...
        { Berserker = true, Samurai = true, ["Cyborg Ninja"] = true, Paladin = true, Cremator = true },
    ...
    HORDE:CreateItem( "SMG", "PP Bizon", "arccw_horde_bizon", 2000, 5,
        ...
        { Survivor = true, Psycho = true, Prototype = true, Assault = true, SpecOps = true, Reverend = true },
    ...
    HORDE:CreateItem( "Shotgun", "Masterkey", "arccw_horde_masterkey", 1250, 3,
        ...
        { Survivor = true, Psycho = true, Prototype = true, Assault = true, SpecOps = true, Reverend = true, Heavy = true, Juggernaut = true, Medic = true, Hatcher = true, Demolition = true, Ghost = true, Engineer = true, Berserker = true, Samurai = true, ["Cyborg Ninja"] = true, Warden = true, Overlord = true, Paladin = true, Cremator = true },
        5, -1, nil, nil, nil, nil, { HORDE.DMG_BALLISTIC } )
    ...
    HORDE:CreateItem( "Shotgun", "HSG-1", "arccw_horde_hsg1", 3000, 8,
        ...
        { Prototype = true, Warden = true, Overlord = true }, 15, -1, nil, nil, { Warden = 2 }, nil, { HORDE.DMG_BALLISTIC } )
    HORDE:CreateItem( "Shotgun", "AA12", "arccw_horde_aa12", 3750, 9,
        "Atchisson Assault Shotgun.\nDevastating firepower at close to medium range.",
        { Prototype = true, Heavy = true, Juggernaut = true, Warden = true, Overlord = true }, 25, -1, nil, nil, { Warden = 3 }, nil, { HORDE.DMG_BALLISTIC } )

    HORDE:CreateItem( "Rifle", "AR15", "arccw_horde_ar15", 2000, 6,
        "AR-15 Style Rifle.\nA lightweight semi-automatic rifle based on the ArmaLite AR-15 design.",
        { Survivor = true, Psycho = true, Assault = true, SpecOps = true, Reverend = true, Medic = true, Hatcher = true, Ghost = true, Gunslinger = true },
    ...
    HORDE:CreateItem( "Explosive", "Frag Grenade", "weapon_frag", 10, 0,
        ...
        { Survivor = true, Psycho = true, Prototype = true },
    ...
    HORDE:CreateItem( "Explosive", "USAS-12", "arccw_horde_usas12", 3000, 9,
        ...
        { Assault = true, SpecOps = true, Reverend = true, Heavy = true, Juggernaut = true, Demolition = true, Warden = true, Overlord = true },
...
Hysteria lasts for 5 seconds and falls off sequentially.]],
    ...
    HORDE:CreateItem( "Special", "Heat Crossbow", "arccw_horde_heat_crossbow", 2000, 5,
        ...
        { Survivor = true, Psycho = true, Ghost = true, Gunslinger = true, Cremator = true },
    ...
    HORDE:CreateItem( "Equipment", "Medkit", "weapon_horde_medkit", 50, 0,
        ...
        nil, 10, -1, nil, "items/weapon_medkit.png", nil, nil, nil, nil, { "Survivor", "Psycho", "Prototype", "Assault", "SpecOps", "Reverend", "Heavy", "Carcass", "Juggernaut", "Medic", "Hatcher", "Demolition", "Warlock", "Ghost", "Gunslinger", "Engineer", "Necromancer", "Berserker", "Samurai", "Cyborg Ninja", "Warden", "Overlord", "Paladin", "Cremator", "Artificer" } )
...
function HORDE:GetArcCWAttachments()
    ...
    {Medic=true, Assault=true, Heavy=true, Demolition=true, Survivor=true, Ghost=false, Engineer=false}, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Barrel", arccw_attachment_wpn="arccw_horde_ump"})
    ...
    {Medic=true, Assault=true, Heavy=true, Demolition=true, Survivor=true, Ghost=false, Engineer=true}, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Barrel", arccw_attachment_wpn="arccw_horde_mag7"})
    ...
    {Medic=true, Assault=true, Heavy=true, Demolition=true, Survivor=true, Ghost=false, Engineer=true}, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Barrel", arccw_attachment_wpn="arccw_horde_nova"})
    ...
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Magazine", arccw_attachment_wpn="arccw_horde_tec9"})
    ...
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Magazine", arccw_attachment_wpn="arccw_horde_ump"})
    ...
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Magazine", arccw_attachment_wpn="arccw_horde_nova"})
    HORDE:CreateItem("Attachment", "[Mag7] 3-Round 12-Gauge",   "go_mag7_mag_3",  90,  0, "",
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Magazine", arccw_attachment_wpn="arccw_horde_mag7"})
    ...
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Slide", arccw_attachment_wpn="arccw_horde_usp"})
    ...
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Slide", arccw_attachment_wpn="arccw_horde_glock"})
    ...
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Slide", arccw_attachment_wpn="arccw_horde_p2000"})
    ...
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Slide", arccw_attachment_wpn="arccw_horde_p250"})
    ...
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Slide", arccw_attachment_wpn="arccw_horde_cz75"})
    ...
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Slide", arccw_attachment_wpn="arccw_horde_fiveseven"})
    ...
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Slide", arccw_attachment_wpn="arccw_horde_deagle"})
    ...
    nil, 10, -1, {type=HORDE.ENTITY_PROPERTY_GIVE, is_arccw_attachment=true, arccw_attachment_type="Slide", arccw_attachment_wpn="arccw_horde_m9"})
