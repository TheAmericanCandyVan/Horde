...
AddCSLuaFile("arccw/attachments/horde_ubgl_incendiary.lua")
AddCSLuaFile("arccw/attachments/horde_ubgl_shock.lua")
AddCSLuaFile("arccw/attachments/horde_ubgl_cryo.lua")
AddCSLuaFile("arccw/attachments/horde_ammo_ap.lua")
AddCSLuaFile("arccw/attachments/horde_ammo_sabot.lua")
AddCSLuaFile("arccw/attachments/horde_bo_extended_mag.lua")
AddCSLuaFile("arccw/attachments/horde_bo_silencer.lua")
AddCSLuaFile("arccw/attachments/bo1_skorpion_ext_mag.lua")
AddCSLuaFile("arccw/attachments/bo1_skorpion_stock_folded.lua")
AddCSLuaFile("arccw/attachments/bo1_skorpion_stock_unfolded.lua")
AddCSLuaFile("arccw/attachments/eap_usas_barrel_short.lua")
AddCSLuaFile("arccw/attachments/eap_usas_mag_6.lua")
AddCSLuaFile("arccw/attachments/eap_usas_mag_drum.lua")
AddCSLuaFile("arccw/attachments/eap_usas_stock_light.lua")
AddCSLuaFile("arccw/attachments/eap_usas_stock_reinforced.lua")
AddCSLuaFile("arccw/attachments/horde_go_perk_bandito.lua")
AddCSLuaFile("arccw/attachments/horde_negev_hemo_belt.lua")
AddCSLuaFile("arccw/attachments/horde_m249_12g_belt.lua")
...
include("arccw/attachments/horde_bo_extended_mag.lua")
include("arccw/attachments/horde_bo_silencer.lua")
